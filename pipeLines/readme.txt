...
### CD34
CD34.DAB.cp426.v2.cppipe                > file name to png, exports all data, only uses normalized tiles created by EntropyMasker or custom masking method (Unet); correct meta-data extraction
CD34.LRP.cp426.v2.cppipe

CD34.DAB.cp413.v1.1.cppipe				> file name to png, exports all data, only uses normalized tiles created by ExpressHist ('crossed tiles') & slideNormalize; correct meta-data extraction > moved to _legacy_archived
...
### CD66b
CD66b.cp426.v2.cppipe                   > file name to png, exports all data, only uses normalized tiles created by EntropyMasker or custom masking method (Unet); correct meta-data extraction

CD66b.cp413.v2.1.cppipe					> file name to png, exports all data, only uses normalized tiles created by ExpressHist ('crossed tiles') & slideNormalize; correct meta-data extraction > moved to _legacy_archived
...
### CD68
CD68.cp426.v2.cppipe                   > file name to png, exports all data, only uses normalized tiles created by EntropyMasker or custom masking method (Unet); correct meta-data extraction

CD68.cp413.v1.1.cppipe					> file name to png, exports all data, only uses normalized tiles created by ExpressHist ('crossed tiles') & slideNormalize; correct meta-data extraction > moved to _legacy_archived
...
### EVG
EVG.cp426.v2.cppipe                   > file name to png, exports all data, only uses normalized tiles created by EntropyMasker or custom masking method (Unet); correct meta-data extraction

EVG.cp413.v1.1.cppipe					> file name to png, exports all data, only uses normalized tiles created by ExpressHist ('crossed tiles') & slideNormalize; correct meta-data extraction > moved to _legacy_archived
...
### Fibrin
FIBRIN.cp426.v2.cppipe                   > file name to png, exports all data, only uses normalized tiles created by EntropyMasker or custom masking method (Unet); correct meta-data extraction

Fibrin.cp413.v1.1.cppipe                > moved to _legacy_archived
...
GLYCC.cp426.v2.cppipe                   > file name to png, exports all data, only uses normalized tiles created by EntropyMasker or custom masking method (Unet); correct meta-data extraction

GLYCC.cp413.v1.1.cppipe					> exports png, export all data, analyses only normalized tiles created by ExpressHist ('crossed tiles') & slideNormalize; correct meta-data extraction > moved to _legacy_archived
...
HE.cp426.v2.cppipe                   > file name to png, exports all data, only uses normalized tiles created by EntropyMasker or custom masking method (Unet); correct meta-data extraction

HE.cp413.v1.1.cppipe					> file name to png, exports all data, only uses normalized tiles created by ExpressHist ('crossed tiles') & slideNormalize; correct meta-data extraction > moved to _legacy_archived
...
SMA.cp426.v2.cppipe                   > file name to png, exports all data, only uses normalized tiles created by EntropyMasker or custom masking method (Unet); correct meta-data extraction

SMA.cp413.v1.1.cppipe					> exports png, export all data, analyses only normalized tiles created by ExpressHist ('crossed tiles') & slideNormalize; correct meta-data extraction > moved to _legacy_archived
SMA.cp413.v1.1.cpproj
SMA.cp413.v1.1.imageset_tested.csv
SMA.cp413.v1.1.notes.txt

### SR
SR.cp426.v2.cppipe                   > file name to png, exports all data, only uses normalized tiles created by EntropyMasker or custom masking method (Unet); correct meta-data extraction
