...
VAL = sum(df$AreaOccupied_AreaOccupied_Fibrin_Tissue) / sum(df$AreaOccupied_AreaOccupied_Tissue)
VAL2 = sum(df$AreaOccupied_AreaOccupied_Fibrin_Tissue)
VAL3 = sum(df$AreaOccupied_AreaOccupied_Tissue)
# original code
